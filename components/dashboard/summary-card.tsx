...
export function SummaryCard({ title, value, icon, trend, trendUp, highlighted }: SummaryCardProps) {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        {trendUp !== null && (
          <div className={cn("flex items-center gap-1 text-sm", trendUp ? "text-green-600" : "text-red-600")}>
